...
import com.twotanwin.spring_boot_store_api.models.RoleName
import com.twotanwin.spring_boot_store_api.models.User
import com.twotanwin.spring_boot_store_api.repository.RoleRepository
import com.twotanwin.spring_boot_store_api.repository.UserRepository
...
class UserService(
    ...
    private fun registerUserWithRole(username: String, email: String, password: String, roleName: RoleName): User {
        try {
            ...
            val role = roleRepository.findByRoleName(roleName.toString())
